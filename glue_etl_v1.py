...
bucket_name = 'dea-prj01-aws-bucket'
prefix = 'warehouse/'
...
Mark_node1704390766767 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://dea-prj01-aws-bucket/staging/marks_v2/"],
        "recurse": True,
    },
...
Student_node1704390766920 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://dea-prj01-aws-bucket/staging/students_v2/"],
        "recurse": True,
    },
...
DW_node1704390869493 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://dea-prj01-aws-bucket/warehouse/"],
        "recurse": True,
    },
...
AmazonS3_node1704390958322 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://dea-prj01-aws-bucket/warehouse/",
        "partitionKeys": [],
    },
